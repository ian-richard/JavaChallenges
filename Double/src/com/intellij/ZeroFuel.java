...
//        about 25 miles per gallon. There are 2 gallons left. Considering these factors, write a function that
//        tells you if it is possible to get to the pump or not. Function should return true (1 in Prolog) if
